...
const graphics::lineStyle graphics::axisTicks::DefaultAxisTickStyle( 3 );

// ------------------------------------------------------------

void graphics::axisTicks::draw( painter &Painter, const scale &Scale, const std::vector<number> &Ticks )
{
...
void graphics::axisTicksX::drawOneTick( painter &Painter, const scale &Scale, number Value )
{
...
void graphics::axisTicksY::drawOneTick( painter &Painter, const scale &Scale, number Value )
{
