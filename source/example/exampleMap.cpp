...
int main( int argc, char **argv )
{
  ...
  Maps[0]->setColorStrategy( new scigraphics::map::graphViewRectangle::grayscalePointColorStrategy() );
  Maps[1]->setColorStrategy( new scigraphics::map::graphViewRectangle::redYellowBluePointColorStrategy() );
  Maps[2]->setColorStrategy( new scigraphics::map::graphViewRectangle::yellowRedBluePointColorStrategy() );
